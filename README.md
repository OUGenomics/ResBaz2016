...
>mkdir -p /opt/local/software/usearch cd /opt/local/software/usearch wget
>http://mgmic.oscer.ou.edu/sequence_data/tutorials/usearch5.2.236_i86linux32wget
>http://mgmic.oscer.ou.edu/sequence_data/tutorials/usearch6.1.544_i86linux32chmod 777 * cd /usr/local/bin ln -s
>/opt/local/software/usearch/usearch5.2.236_i86linux32 ./usearch ln -s /opt/local/software/usearch/usearch6.1.544_i86linux32 ./usearch61
